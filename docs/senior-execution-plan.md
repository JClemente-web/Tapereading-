...
3. **Protótipo validável**: criar um dashboard/simulador antes de depender de integração real com o ProfitPro.
...
> “Crie a matriz profissional de confluências e o catálogo de alertas para a ferramenta de Tape Reading em WDO, com referências, critérios de invalidação, severidade e exemplos operacionais.”
